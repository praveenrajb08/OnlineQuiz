	...
	if(request.getParameter("btn_login")!=null) //check login button click event not null
	{
		...
		if(rs.next())
		{
			...
			if(email.equals(dbemail) && password.equals(dbpassword))
			{
				...
				response.sendRedirect("homepage.html"); //after login success redirect to welcome.jsp page
			}
		}
		else
		{
    ...
    <div class="main-content">
        ...
        <form class="form-register" method="post" name="myform" onsubmit="return validate();">
            ...
            <div class="form-register-with-email">
				...
				<a href="register.jsp" class="form-log-in-with-existing">You Don't have an account? <b> Register here </b></a><br><br><br>
				<a href="forgetpass.jsp" class="form-log-in-with-existing">   did you forget password?   <b> Click Here </b></a>
